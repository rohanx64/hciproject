                ...
                <div className="mb-6 rounded-2xl border-2 border-[#c8f0c0] bg-white px-4 py-4">
                    ...
                    <div className="pt-3 border-t-2 border-gray-200 space-y-2">
                        <div className="flex justify-between">
                            <span className="text-sm font-semibold text-gray-600">Purchase Value</span>
                            <span className="text-sm font-bold text-text-dark">{purchaseValue} Rs.</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-sm font-semibold text-gray-600">Delivery Fare</span>
