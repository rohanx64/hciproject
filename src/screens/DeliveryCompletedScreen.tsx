...
export function DeliveryCompletedScreen({
    ...
    return (
        <div className="w-full h-full flex flex-col overflow-hidden rounded-[40px] bg-white shadow-2xl relative">
            {/* Header */}
            <header className="px-6 py-4 flex items-center gap-4 z-10 relative" style={{ backgroundColor: DELIVERY_COLOR }}>
                <button
                    onClick={onBack || (() => onNavigate?.('deliveryHome'))}
                ...
                <h1 className="text-xl font-bold text-white flex-1">Delivery Completed</h1>
            </header>
                    ...
                    <div className="bg-gray-50 rounded-2xl p-4 border-2 border-gray-200">
                        <div className="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div>
                                ...
                                <p className="font-bold" style={{ color: DELIVERY_COLOR }}>{price}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-4 border-2 border-gray-200">
                        <div className="flex items-center gap-3">
                            {riderAvatar ? (
                                ...
                                <div className="size-12 rounded-full border-2 border-gray-200 flex items-center justify-center" style={{ background: `linear-gradient(to bottom right, ${DELIVERY_COLOR}, #e68600)` }}>
