                                    ...
                                    <div className="relative">
                                            ...
                                            <div className="absolute inset-0 flex justify-between items-center">
                                                {[500, 1000, 1500, 2000, 2500].map((value) => {
                                                    ...
                                                    return (
                                                        <div
                                                            key={value}
                                                            className={`size-3 rounded-full transition-all duration-200 ${isActive ? 'bg-[#3b82f6] shadow-md scale-125' : 'bg-gray-300'
                                                                }`}
                                                        />
                                                    )
                                                })}
                                        ...
                                        <div className="flex justify-between mt-3">
                                            {[500, 1000, 1500, 2000, 2500].map((value) => (
                                                <span
                                                    key={value}
                                                    className={`text-xs font-semibold transition-colors duration-200 ${purchaseValue === value ? 'text-[#3b82f6]' : 'text-gray-400'
                                                        }`}
                                                >
                                                    {value}
                                                </span>
