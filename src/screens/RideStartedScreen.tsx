            ...
            <section className="flex-1 bg-white px-6 py-6 overflow-y-auto">
                ...
                <div className="mb-6">
                    <button
                        ...
                        className="w-full rounded-full bg-primary px-6 py-4 flex items-center justify-center gap-3 shadow-lg hover:bg-primary-dark active:scale-95 transition-all duration-200"
                    >
                        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        <span className="text-lg font-extrabold text-white">Complete Ride</span>
                    </button>
                </div>
            </section>
