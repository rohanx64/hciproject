    ...
    return (
        <div className="w-full h-full flex flex-col overflow-hidden rounded-[40px] bg-white shadow-2xl relative">
            ...
            <header className="bg-primary px-6 py-4 flex items-center gap-4 z-10 relative">
                ...
                <h1 className="text-xl font-bold text-white">{t('Call AIR')}</h1>
            </header>
            ...
            <main className="flex-1 overflow-y-auto bg-white flex flex-col items-center justify-center px-6 py-8">
                <div className="text-center space-y-6 max-w-sm">
                    ...
                    {/* Title */}
                    <h2 className="text-2xl font-bold text-text-dark">{t('Call AIR Representative')}</h2>

                    {/* Description */}
                    <p className="text-base text-gray-600 leading-relaxed">
                        {t('Speak directly with an AIR representative to place your order via phone. No need to navigate through the app - just call and order!')}
                    </p>

                    {/* Phone Number */}
                    <div className="bg-gray-50 rounded-2xl p-4">
                        <p className="text-sm text-gray-500 mb-1">{t('Call us at')}</p>
